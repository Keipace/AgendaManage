...
public class TargetUtil {
    ...
    public static View.OnTouchListener getOnTouchListener(Context context, EditText planOverDate, EditText deadLineDate, EditText preDoDate, int position){
    ...
    // 将焦点获取到确定按钮上
    public static void setFocusOnButton(Button button){
