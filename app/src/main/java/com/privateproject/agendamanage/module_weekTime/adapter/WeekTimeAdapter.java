...
import com.privateproject.agendamanage.databinding.WeektimeItemWeekTimeAddLayoutBinding;
import com.privateproject.agendamanage.module_weekTime.activity.WeekTimeEditChoiseActivity;
...
import com.privateproject.agendamanage.module_weekTime.viewHolder.WeekTimeViewHolder;
                ...
                public void onClick(View v) {
                    ...
                    if (hasCourse(row, col)) {
                        ...
                        if (clickedRow==-1||clickedCol==-1) {
                            ...
                            // 第二次点击相同的那一个
                            //1.显示弹出框
                            WeektimeItemWeekTimeAddLayoutBinding dialogBinding = WeektimeItemWeekTimeAddLayoutBinding.inflate(context.getLayoutInflater());
                            //添加每周事件
