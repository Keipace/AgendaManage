...
public class WeekTimeEditChoiseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.weektime_item_week_time_edit_choise_layout);
        ...
        RecyclerView.Adapter adapter = new RecyclerView.Adapter<CourseViewHolder>() {
            ...
            public CourseViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
                View view = LayoutInflater.from(WeekTimeEditChoiseActivity.this).inflate(R.layout.weektime_item_week_time_course_list, parent, false);
    ...
    private void showDialog(boolean isAdd, int position, InnerListener innerListener) {
        View view = LayoutInflater.from(WeekTimeEditChoiseActivity.this).inflate(R.layout.weektime_item_week_time_add_layout, null);
